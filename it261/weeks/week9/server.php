<?php
//our server page - this is where we are connecting to our database
...
if($rows) {
    ...
    // if username is alreay taking > show error
...
if(count($errors) < 1){
// introduce a new function md5() - this function will spit out in your databse a 32 hex xharaxter
//value for your password
...
if(isset($_POST['login_user'])){
    ...
    // we are going to count errors - and if they equal to 0, we are happy
    ...
    // if username and password is equal to one, life is good
